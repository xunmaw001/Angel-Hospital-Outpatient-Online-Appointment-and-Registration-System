<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'" label="留言编号" prop="liuyanbianhao">
					<el-input v-model="ruleForm.liuyanbianhao" placeholder="留言编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.liuyanbianhao" label="留言编号" prop="liuyanbianhao">
					<el-input v-model="ruleForm.liuyanbianhao" placeholder="留言编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="患者账号" prop="huanzhezhanghao">
					<el-input v-model="ruleForm.huanzhezhanghao" placeholder="患者账号" clearable  :readonly="ro.huanzhezhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="患者账号" prop="huanzhezhanghao">
					<el-input v-model="ruleForm.huanzhezhanghao" placeholder="患者账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="咨询时间" prop="zixunshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.zixunshijian" label="咨询时间" prop="zixunshijian">
					<el-input v-model="ruleForm.zixunshijian" placeholder="咨询时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-if="type!='info'"  label="咨询内容" prop="zixunneirong">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else-if="ruleForm.zixunneirong" label="咨询内容" prop="zixunneirong">
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='liuyanbianhao'){
							this.ruleForm.liuyanbianhao = obj[o];
							this.ro.liuyanbianhao = true;
							continue;
						}
						if(o=='yishenggonghao'){
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(json.huanzhezhanghao!=''&&json.huanzhezhanghao && this.$storage.get("role")!="管理员"){
	...
	this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../ssm1n539/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
