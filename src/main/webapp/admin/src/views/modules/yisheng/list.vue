				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button :style='{"border":"1px solid #a347ea","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#a347ea","borderRadius":"20px","background":"#f3eafa","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('yisheng','挂号')" type="success" size="mini" @click="zhuanjiayuyueCrossAddOrUpdateHandler(scope.row,'cross','','','')">挂号</el-button>
							<el-button :style='{"border":"1px solid #a347ea","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#a347ea","borderRadius":"20px","background":"#f3eafa","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('yisheng','在线咨询')" type="success" size="mini" @click="zaixianzixunCrossAddOrUpdateHandler(scope.row,'cross','','','')">在线咨询</el-button>
...
export default {
  ...
  methods: {
    ...
    zhuanjiayuyueCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
