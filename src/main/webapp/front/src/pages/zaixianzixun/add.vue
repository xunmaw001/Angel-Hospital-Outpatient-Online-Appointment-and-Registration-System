...
<div :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.0)"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="留言编号" prop="liuyanbianhao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="咨询时间" prop="zixunshijian" >
              <el-date-picker
