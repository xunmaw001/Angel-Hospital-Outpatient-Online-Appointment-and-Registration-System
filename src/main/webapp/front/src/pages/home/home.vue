...
<div class="home-preview" :style='{"width":"90%","margin":"10px auto","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}'>
		...
		<div class="title" :style='{"width":"100%","padding":"0 20px","margin":"0 auto 20px","lineHeight":"50px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20230106/3c1030df5b01476da876dcb77796e839.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230106/f2208a9b176f427fa196c3e89d7bf7e1.png) no-repeat right top / auto 100%,url(http://codegen.caihongy.cn/20230106/539e485aa0d94fea9f2fbd11dd4c74b6.png) repeat-x center center / auto 100%"}'>
			<span :style='{"color":"#333","fontSize":"16px"}'>医院公告</span>
		</div>
...
<div class="recommend" :style='{"width":"100%","margin":"10px auto 10px","position":"relative","background":"none"}'>
    ...
    <div class="title" :style='{"width":"100%","padding":"0 20px","margin":"0px auto 0px","lineHeight":"50px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20230106/3c1030df5b01476da876dcb77796e839.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230106/f2208a9b176f427fa196c3e89d7bf7e1.png) no-repeat right top / auto 100%,url(http://codegen.caihongy.cn/20230106/539e485aa0d94fea9f2fbd11dd4c74b6.png) repeat-x center center / auto 100%"}'>
		<span :style='{"color":"#333","fontSize":"16px"}'>医生推荐</span>
	</div>
	...
	<div class="list list5 index-pv1">
		<div id="recommend-five-swiperyisheng" class="swiper-container recommend-five-swiper" :style='{"width":"100%","padding":"50px 10px","margin":"10px 0","background":"none"}'>
			<div class="swiper-wrapper">
				<div :style='{"border":"0px solid #e6e6e6","padding":"10px","fontSize":"0","position":"relative","borderRadius":"4px"}' class="swiper-slide" v-for="(item,index) in yishengRecommend" :key="index" @click="toDetail('yishengDetail', item)">
					<img :style='{"border":"0","width":"100%","height":"220px"}' v-if="item.touxiang.substr(0,4)=='http'" :src="item.touxiang.split(',')[0]" alt="" />
					<img :style='{"border":"0","width":"100%","height":"220px"}' v-else :src="baseUrl + (item.touxiang?item.touxiang.split(',')[0]:'')" alt="" />
				</div>
			</div>
			<!-- Add Arrows -->
	...
	<div @click="moreBtn('yisheng')" :style='{"border":"0","padding":"0 20px","margin":"0px auto 0px","top":"0","textAlign":"center","background":"none","display":"block","width":"auto","lineHeight":"50px","position":"absolute","right":"20px"}'>
...
<div class="lists" :style='{"width":"60%","margin":"20px auto 0px","position":"relative","background":"none"}'>
	...
	<div class="title" :style='{"width":"100%","margin":"0px auto 0px","lineHeight":"50px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20230106/3c1030df5b01476da876dcb77796e839.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230106/f2208a9b176f427fa196c3e89d7bf7e1.png) no-repeat right top / auto 100%,url(http://codegen.caihongy.cn/20230106/539e485aa0d94fea9f2fbd11dd4c74b6.png) repeat-x center center / auto 100%"}'>
	  <span :style='{"color":"#333","margin":"0 8px 0 20px","fontSize":"18px"}'>医生展示</span>
	</div>
	...
	<div class="list list2 index-pv1" :style='{"padding":"0 20px","margin":"20px 0px 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"border":"1px solid #e6e6e6","padding":"10px","margin":"0 0 20px","flexWrap":"wrap","background":"rgba(255,255,255,1)","display":"flex","width":"48%","position":"relative","justifyContent":"space-between","height":"212px"}' v-for="(item,index) in yishengList" class="list-item animation-box" :key="index" @click="toDetail('yishengDetail', item)">
			<img :style='{"width":"48%","boxShadow":"0px 56px 36px -60px #999","objectFit":"cover","borderRadius":"4px","display":"inline-block","height":"90%"}' v-if="item.touxiang.substr(0,4)=='http'" :src="item.touxiang.split(',')[0]" alt="" />
			<img :style='{"width":"48%","boxShadow":"0px 56px 36px -60px #999","objectFit":"cover","borderRadius":"4px","display":"inline-block","height":"90%"}' v-else :src="baseUrl +  (item.touxiang?item.touxiang.split(',')[0]:'')" alt="" />
			<div :style='{"width":"48%","padding":"10px 0px","overflow":"hidden","display":"inline-block","height":"100%"}' class="item-info">
				<div class="name line1" :style='{"borderColor":"#eee","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#3d74c0","borderWidth":"0 0 1px","width":"90%","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"solid"}'>{{item.yishengxingming}}</div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('yisheng')" :style='{"border":"0","padding":"0 20px","margin":"0px auto 40px","top":"0","textAlign":"center","background":"none","display":"block","width":"auto","lineHeight":"50px","position":"absolute","right":"20px"}'>
		<span :style='{"color":"#555","fontSize":"14px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#555","fontSize":"14px"}' class="el-icon-d-arrow-right"></i>
	</div>
...
<div class="lists" :style='{"width":"60%","margin":"20px auto 0px","position":"relative","background":"none"}'>
	...
	<div class="title" :style='{"width":"100%","margin":"0px auto 0px","lineHeight":"50px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20230106/3c1030df5b01476da876dcb77796e839.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230106/f2208a9b176f427fa196c3e89d7bf7e1.png) no-repeat right top / auto 100%,url(http://codegen.caihongy.cn/20230106/539e485aa0d94fea9f2fbd11dd4c74b6.png) repeat-x center center / auto 100%"}'>
	  <span :style='{"color":"#333","margin":"0 8px 0 20px","fontSize":"18px"}'>科室信息展示</span>
	</div>
	...
	<!-- 样式二 -->
	<div class="list list2 index-pv1" :style='{"padding":"0 20px","margin":"20px 0px 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"border":"1px solid #e6e6e6","padding":"10px","margin":"0 0 20px","flexWrap":"wrap","background":"rgba(255,255,255,1)","display":"flex","width":"48%","position":"relative","justifyContent":"space-between","height":"212px"}' v-for="(item,index) in keshixinxiList" class="list-item animation-box" :key="index" @click="toDetail('keshixinxiDetail', item)">
			<img :style='{"width":"48%","boxShadow":"0px 56px 36px -60px #999","objectFit":"cover","borderRadius":"4px","display":"inline-block","height":"90%"}' v-if="item.keshifengmian.substr(0,4)=='http'" :src="item.keshifengmian.split(',')[0]" alt="" />
			<img :style='{"width":"48%","boxShadow":"0px 56px 36px -60px #999","objectFit":"cover","borderRadius":"4px","display":"inline-block","height":"90%"}' v-else :src="baseUrl +  (item.keshifengmian?item.keshifengmian.split(',')[0]:'')" alt="" />
			<div :style='{"width":"48%","padding":"10px 0px","overflow":"hidden","display":"inline-block","height":"100%"}' class="item-info">
				<div class="name line1" :style='{"borderColor":"#eee","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#3d74c0","borderWidth":"0 0 1px","width":"90%","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"solid"}'>{{item.keshi}}</div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('keshixinxi')" :style='{"border":"0","padding":"0 20px","margin":"0px auto 40px","top":"0","textAlign":"center","background":"none","display":"block","width":"auto","lineHeight":"50px","position":"absolute","right":"20px"}'>
		<span :style='{"color":"#555","fontSize":"14px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#555","fontSize":"14px"}' class="el-icon-d-arrow-right"></i>
	</div>
          ...
          autoSortUrl = "yisheng/autoSort";
			this.$http.get(autoSortUrl, {params: {
				...
				if (res.data.code == 0) {
					...
					// 商品列表样式五
					this.$nextTick(() => {
						new Swiper('#recommend-five-swiperyisheng', {
							loop: true,
							speed: 500,
			...
			this.$http.get('yisheng/list', {params: {
				page: 1,
				limit: 4,
			}}).then(res => {
				if (res.data.code == 0) {
					this.yishengList = res.data.data.list;
					
					// 商品列表样式五
					
				}
			});
			this.$http.get('keshixinxi/list', {params: {
				page: 1,
				limit: 4,
			}}).then(res => {
				if (res.data.code == 0) {
					this.keshixinxiList = res.data.data.list;
