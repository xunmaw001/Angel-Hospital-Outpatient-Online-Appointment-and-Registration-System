...
public class ZaixianzixunEntity<T> implements Serializable {
	 ...
	 * 设置：留言编号
	 */
	public void setLiuyanbianhao(String liuyanbianhao) {
		this.liuyanbianhao = liuyanbianhao;
	}
	/**
	 * 获取：留言编号
	 */
	public String getLiuyanbianhao() {
		return liuyanbianhao;
	}
	/**
	 * 设置：医生工号
	 */
